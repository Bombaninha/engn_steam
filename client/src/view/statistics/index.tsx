    ...
    return (
        <div className="page">
            ...
            <div className="statistics">
                <SelectInput value={reportTypeValue} label='Tipo de relatório' identification='report-type' options={[{ value: 'sales', label: 'Vendas de jogos', key: uuid() }, { value: 'tickets', label: 'Tickets resolvidos', key: uuid() }]} onChange={select => setReportTypeValue(select)} />
