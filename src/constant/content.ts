...
export const gamesListPopulate: TGame[] = [
    {
        title: "Doom",
        categories: ["FPS", "Ação"],
        description: "Doom é um jogo eletrônico de tiro em primeira pessoa desenvolvido pela id Software e publicado pela Bethesda Softworks. Foi lançado mundialmente em 13 de maio de 2016 para Microsoft Windows, PlayStation 4 e Xbox One. Uma versão para o Nintendo Switch foi lançada em 10 de novembro de 2017 e para o Google Stadia em agosto de 2020. É o quarto título principal da série Doom e o primeiro grande jogo da série lançado desde Doom 3 em 2004. A história acompanha um fuzileiro espacial enquanto luta contra forças demoníacas em uma colônia de Marte.",
        price: 14.00,
